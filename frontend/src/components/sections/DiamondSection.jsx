    ...
    <section className="why-mygen py-24 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4">
        <div className="narrative-content max-w-6xl mx-auto text-center">
          ...
          <div className="solution-principles relative max-w-4xl mx-auto">
            {/* Top box - WHY */}
            <div className="principle-item flex flex-col items-center justify-center bg-orange-500/5 border border-orange-500/10 rounded-2xl p-6 transition-all duration-300 hover:bg-orange-500/10 hover:border-orange-500/20 hover:transform hover:-translate-y-2 w-64 mx-auto mb-8">
            ...
            {/* Middle row - MORE and LESS */}
            <div className="flex justify-center gap-8 mb-8">
              <div className="principle-item flex flex-col items-center justify-center bg-orange-500/5 border border-orange-500/10 rounded-2xl p-6 transition-all duration-300 hover:bg-orange-500/10 hover:border-orange-500/20 hover:transform hover:-translate-y-2 w-64">
                <div className="principle-icon w-12 h-12 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl flex items-center justify-center mb-6">
                  <CheckCircle className="w-6 h-6 text-white" />
                </div>
                <div className="principle-content text-center">
                  <h4 className="text-white text-lg font-semibold mb-2">
                    <span className="principle-default">5 Do More's</span>
                  </h4>
              ...
              <div className="principle-item flex flex-col items-center justify-center bg-orange-500/5 border border-orange-500/10 rounded-2xl p-6 transition-all duration-300 hover:bg-orange-500/10 hover:border-orange-500/20 hover:transform hover:-translate-y-2 w-64">
                ...
                <div className="principle-content text-center">
                  <h4 className="text-white text-lg font-semibold mb-2">
                    <span className="principle-default">5 Do Less's</span>
                  </h4>
            ...
            <div className="principle-item flex flex-col items-center justify-center bg-orange-500/5 border border-orange-500/10 rounded-2xl p-6 transition-all duration-300 hover:bg-orange-500/10 hover:border-orange-500/20 hover:transform hover:-translate-y-2 w-64 mx-auto">
              <div className="principle-icon w-12 h-12 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl flex items-center justify-center mb-6">
